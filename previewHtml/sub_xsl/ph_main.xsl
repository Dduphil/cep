...
* Cmt_Row : boobstrap row (12 part)     
    ...
    <xsl:template name="tplAddBootstapCss">
        ...
        <xsl:choose>
            ...
            <xsl:when test="'test-v4' = $optBootstrap">
                <link rel="stylesheet" href="../projets/clicEdit/3_dev/gh_ce-master/ce/Schema/lib/bootstrap-4.3.1.npm/node_modules/bootstrap/dist/css/bootstrap.min.css"/>
            </xsl:when>
            <xsl:otherwise>
